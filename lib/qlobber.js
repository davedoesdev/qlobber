...
Qlobber.prototype._match2 = function (v, topic, ctx)
{
    ...
    {
        source: v
    }, 0, this._split(topic), this._trie, ctx);
...
Qlobber.prototype._split = function (topic) {
...
Qlobber.prototype.add = function (topic, val)
{
    ...
    {
        shortcut = this._add(val, 0, this._split(topic), this._trie);
        if (this._shortcuts)
        {
...
{
    if (this._remove(val, 0, this._split(topic), this._trie) && this._shortcuts)
    {
...
{
    return this._match_iter(0, this._split(topic), this._trie, ctx);
};
...
{
    return this._test(val, 0, this._split(topic), this._trie);
};
