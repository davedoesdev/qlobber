...
// function to add get_trie to native
// we can use visit and then make the trie
// perhaps create a non-native qlobber of same type and restore it?
...
function wrap_native(QlobberNative, Qlobber)
{
    class WrappedQlobberNative extends QlobberNative
    {
        *visit()
        ...
        get_restorer()
        {
            const restorer = super.get_restorer();
            return obj => {
