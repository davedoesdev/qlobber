...
Qlobber.prototype._add = function (val, i, s, sub_trie)
{
    var st, code;

    if (i === s.length)
    {
        st = sub_trie[this._leaf_code];
...
Qlobber.prototype._match = function (v, i, s, sub_trie, ctx)
{
    var code, st;
...
Qlobber.prototype._test = function (v, i, s, sub_trie)
{
    var code, st;
...
Qlobber.prototype.add = function (topic, val)
{
    ...
    {
        shortcut = this._add(val, 0, topic, this._trie);
        if (this._shortcuts)
        {
...
{
    return this._test(val, 0, topic, this._trie);
};
